/*
  ...
  - You are about to drop the column `horarioPartida` on the `partidas` table. All the data in the column will be lost.
  - You are about to drop the column `localPartida` on the `partidas` table. All the data in the column will be lost.
...
CREATE TABLE "new_partidas" (
    ...
    CONSTRAINT "partidas_id_horario_fkey" FOREIGN KEY ("id_horario") REFERENCES "horarios" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_partidas" ("chave", "dataPartida", "id", "id_campeonato", "id_jogador1", "id_jogador2", "id_pontuacao1", "id_pontuacao2", "id_vencedor") SELECT "chave", "dataPartida", "id", "id_campeonato", "id_jogador1", "id_jogador2", "id_pontuacao1", "id_pontuacao2", "id_vencedor" FROM "partidas";
DROP TABLE "partidas";
